...
Example Field 48 with MAC key index `1` in tag 001 and the wrapped key in tag 002. **Spaces added for readability**. Note that the length of each tag is represented in decimal format:
```
001 001 1 002 144 D0144M6AC00E00000DB97F430EF5FE7839125445749AD6477439749EA17F35F4E1132C076114CC3D87099D9B5612849B68F462E05B1931848C7AE73D4DAB89ABBC31215F2E7623E5
```
...
### 3.1 Details on bitmap

The header of the ISO message consists of the MTI and the bitmap. In this example, the MTI is `1100`, indicating a financial transaction request. The bitmap indicates which fields are present in the message. Here, the bitmap includes Field 64 for the MAC.

```
11007204660008618201
```

The bitmap can be broken down further:

| Byte | Bit Pattern | Fields Present |
|------|-------------|----------------|
| 72   | 01110010    | 2, 3, 4, 7     |
| 04   | 00000100    | 14             |
| 66   | 01100110    | 18, 19, 22, 23 |
| 00   | 00000000    |                | 
| 08   | 00001000    | 37             |
| 61   | 01100001    | 42, 43, 48     |
| 82   | 10000010    | 49, 43, 55     | 
| 01   | 00000001    | 64             |
